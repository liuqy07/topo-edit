  ...
  G6.registerNode(
    'base-node-ifit',
    {
      ...
      drawsscont1(cfg, group, attrs) {
        ...
        const imgalarm = new URL('../../assets/images/topo/ifitTopo_new/warning.png', import.meta.url).href
      ...
      drawsscont(cfg, group, attrs) {
        ...
        const imgalarm = new URL('../../../../../../assets/images/一级告警.png', import.meta.url).href
        group1.addShape('image', {
          attrs: {
            x: -width / 4 + 20,
            y: -height / 2 - 10,
